...
function Profile() {
    ...
    const handlePasswordSubmit = async (e) => {
        ...
        try {
            ...
            if (response.data && response.data.success) {
                ...
                setMessage({ type: 'error', text: response.data.message || 'Failed to change password. Please try again.' });
            }
        } catch (error) {
    ...
    const tabs = [
        { id: 'profile', label: 'Profile Info', icon: IoPerson, gradient: 'from-blue-500 to-purple-500' },
        { id: 'password', label: 'Security', icon: IoLockClosed, gradient: 'from-purple-500 to-pink-500' }
    ];
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="grid grid-cols-1 xl:grid-cols-4 gap-8">
                    ...
                    <div className="xl:col-span-1">
                        ...
                        {/* Enhanced Stats */}
                        <div className="glass-card p-6 mt-6 animate-slide-up glow-effect" style={{ animationDelay: '0.1s' }}>
                    ...
                    <div className="xl:col-span-3">
                        <div className="glass-card rounded-3xl overflow-hidden animate-slide-up glow-effect shadow-2xl" style={{ animationDelay: '0.2s' }}>
                            {/* Enhanced Tabs */}
                            <div className="flex bg-white/5 border-b border-white/20">
                                {tabs.map((tab) => (
                                    ...
                                    >
                                        <div className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all duration-300 ${activeTab === tab.id
                            ...
                            <div className="p-10">
                                ...
                                {message.text && (
                                    <div className={`mb-8 px-6 py-4 rounded-2xl text-sm backdrop-blur-md animate-slide-up flex items-center space-x-3 shadow-lg ${message.type === 'success'
                                        ? 'bg-green-500/20 border border-green-500/30 text-green-300'
                                        : 'bg-red-500/20 border border-red-500/30 text-red-300'
                                        }`}>
                                        <div className={`w-8 h-8 rounded-full flex items-center justify-center ${message.type === 'success' ? 'bg-green-500/30' : 'bg-red-500/30'
                                            }`}>
                                            {message.type === 'success' ? <IoCheckmarkCircle size={18} /> : <IoAlertCircle size={18} />}
                                        </div>
                                    ...
                                    <form onSubmit={handleProfileSubmit} className="space-y-8 animate-fade-in">
                                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                            <div className="space-y-2">
                                                <label htmlFor="name" className="flex text-sm font-semibold text-white/90 mb-3 items-center space-x-2">
                                            ...
                                            <div className="space-y-2">
                                                <label htmlFor="email" className="flex text-sm font-semibold text-white/90 mb-3 items-center space-x-2">
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <CustomSelect
                                                    value={profileData.gender === null ? '' : profileData.gender ? 'female' : 'male'}
                                        ...
                                        <div className="space-y-2">
                                            <label htmlFor="bio" className="flex text-sm font-semibold text-white/90 mb-3 items-center space-x-2">
                                        ...
                                        <div className="flex justify-end space-x-4 pt-6 border-t border-white/20">
                                            ...
                                            <button
                                                type="submit"
                                                disabled={isLoading}
                                                className={`gradient-button flex items-center space-x-2 px-8 py-4 text-lg shadow-2xl ${isLoading ? 'opacity-50 cursor-not-allowed' : ''}`}
                                            >
                                                {isLoading ? (
                                                    <>
                                ...
                                {activeTab === 'password' && (
                                    <form onSubmit={handlePasswordSubmit} className="space-y-8 animate-fade-in">
                                        <div className="max-w-lg space-y-8">
                                            <div className="space-y-2">
                                                <label htmlFor="currentPassword" className="flex text-sm font-semibold text-white/90 mb-3 items-center space-x-2">
                                            ...
                                            <div className="space-y-2">
                                                <label htmlFor="newPassword" className="flex text-sm font-semibold text-white/90 mb-3 items-center space-x-2">
                                                    <div className="w-6 h-6 bg-gradient-to-r from-blue-500 to-purple-500 rounded-lg flex items-center justify-center">
                                            ...
                                            <div className="space-y-2">
                                                <label htmlFor="confirmPassword" className="flex text-sm font-semibold text-white/90 mb-3 items-center space-x-2">
                ...
                <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 animate-fade-in">
                    <div className="glass-card p-8 max-w-md w-full mx-4 rounded-2xl animate-slide-up">
                        <div className="text-center mb-6">
                            ...
                            <p className="text-white/70">Enter the URL of your new profile picture</p>
                        </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex space-x-4">
                                ...
                                <button
                                    ...
                                    className={`flex-1 gradient-button flex items-center justify-center space-x-2 py-3 ${!tempImageUrl.trim() ? 'opacity-50 cursor-not-allowed' : ''
                                        }`}
                                >
                                    <IoSave size={18} />
                                    <span>Update</span>
